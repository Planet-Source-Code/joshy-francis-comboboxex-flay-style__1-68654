...
'ComboBoxEx.
Option Explicit
Dim clsTheme As New clsXPStyle
...
Static B As Boolean
If B = False Then
    clsTheme.EnableTheme Wnd
        B = True
    Command11.Caption = "Style Normal"
Else
    clsTheme.DisableTheme Wnd
        B = False
    Command11.Caption = "Style Flat"
End If
End Sub
...
Dim ctl As Control
    On Error Resume Next
        clsTheme.DisableTheme hwnd
        clsTheme.DisableTheme Wnd
For Each ctl In Me.Controls
    clsTheme.DisableTheme ctl.hwnd
Next
...
Dim ctl As Control
    On Error Resume Next
        clsTheme.EnableTheme hwnd
For Each ctl In Me.Controls
'    clsTheme.EnableTheme ctl.hwnd
    clsTheme.DisableTheme ctl.hwnd
Next
End Sub
